...
@Mapper(nullValueMappingStrategy = NullValueMappingStrategy.RETURN_DEFAULT, unmappedTargetPolicy = ReportingPolicy.IGNORE, uses = BookWithoutAuthorMapper.class)
public interface AuthorWithBooksMapper
{
    ...
    AuthorWithBooksDTO mapEntityToDTO(AuthorEntity entity);
}
